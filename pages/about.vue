        ...
        >
            <div class="flex flex-col justify-between gap-8 lg:flex-row">
                <div class="flex w-full flex-col justify-center lg:w-5/12">
                    <h1
                        class="pb-4 text-3xl font-bold leading-9 text-gray-800 lg:text-4xl"
                    >
                        About Us
                    </h1>
            ...
            <div class="flex flex-col justify-between gap-8 pt-12 lg:flex-row">
                ...
                <div class="w-full lg:w-8/12 lg:pt-8">
                    <div
                        class="grid grid-cols-1 rounded-md shadow-lg sm:grid-cols-2 md:grid-cols-4 lg:gap-4"
                    >
                        <div
                            class="flex flex-col items-center justify-center p-4 pb-6"
                        >
                            <img
                            ...
                            />
                            <p
                                class="mt-4 text-xl font-medium leading-5 text-gray-800"
                            >
                                Alexa
                            </p>
                        </div>
